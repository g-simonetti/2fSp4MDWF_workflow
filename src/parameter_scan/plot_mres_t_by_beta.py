#!/usr/bin/env python3
"""
Plot the residual mass as a function of t for different beta values.
...
and annotated by beta so the output matches the release-style comparison plot.
"""
...
parser = argparse.ArgumentParser(
    description="Plot residual mass as a function of t for different beta values."
)
